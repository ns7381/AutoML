define('yfjs/spa', ['yfjs/spa/app'], function (App) {
    return new App();
});
define('yfjs/spa/app', [
    'yfjs',
...
define('yfjs/spa/util/ajax', ['../version', 'jquery', './helpers', './event', './error'], function (Version, $, _, Event, Error) {
    ...
    Ajax.DEFAULTS = {
        ...
        headers: {
            ...
            'Authorization': getCookie("ml_token_id"),
        ...
        normalizeOptions: function (options, overrides) {
            ...
            var normalizeOption = function (option, override, i, level) {
                ...
                if (_.isArray(option)) {
                    ...
                    obj = self.getOptions();
                    obj.headers.Authorization = getCookie("ml_token_id");
    ...
    if (typeof window.console.emulated === 'undefined') {
        ...
        if (typeof window.console.debug === 'function') {
            ...
            if (typeof window.console.debug === 'undefined') {
                window.console.debug = !window.console.hasLog ? function () {
                } : function () {
        ...
        if (typeof window.console.warn === 'function') {
            ...
            if (typeof window.console.warn === 'undefined') {
                window.console.warn = !window.console.hasLog ? function () {
                } : function () {
...
], function (Version, _, Event, Error, Widget) {
            ...
            for (var i = 0; i < path.length; i++) {
                ...
                if (options.forceAbsolutePath && lastToken == PathWildcardCompiler.LAST_TOKEN_START && ch != PathWildcardCompiler.SLASH) {
                    throw new Error({
                        ...
                        filename: path,
                        number: i,
                        message: 'Path must start with "/" when FORCE_ABSOLUTE_PATH is true.'
                    });
                }
                    ...
                    case PathWildcardCompiler.SLASH:
                        ...
                        if (lastToken == PathWildcardCompiler.LAST_TOKEN_SLASH) {
                            throw new Error({
                                ...
                                filename: path,
                                number: i,
                                message: 'Path can not contains double slash "//".'
                            });
                            ...
                            throw new Error({
                                ...
                                filename: path,
                                number: i,
                                message: 'Path can not starts with "/" when FORCE_RELATIVE_PATH is true.'
                            });
                        }
                        ...
                        if (j < path.length && path.charAt(j) == PathWildcardCompiler.STAR) {
                            ...
                            if (lastToken != PathWildcardCompiler.LAST_TOKEN_START && lastToken != PathWildcardCompiler.LAST_TOKEN_SLASH) {
                                throw new Error({
                                    ...
                                    filename: path,
                                    number: i,
                                    message: 'Double stars "**" in front of only slash "/".'
                                });
                            }
                            ...
                            if (lastToken == PathWildcardCompiler.LAST_TOKEN_STAR || lastToken == PathWildcardCompiler.LAST_TOKEN_DOUBLE_STAR) {
                                throw new Error({
                                    ...
                                    filename: path,
                                    number: i,
                                    message: 'If the front is not slash "/", the front of star "*" cannot be "*" or "**".'
                                });
                            }
                    ...
                    default:
                        ...
                        if (lastToken == PathWildcardCompiler.LAST_TOKEN_DOUBLE_STAR) {
                            throw new Error({
                                ...
                                filename: path,
                                number: i,
                                message: 'Double stars "**" must be followed by slash "/".'
                            });
                        }
                        ...
                        if (/[a-z0-9]/i.test(ch) || ch == PathWildcardCompiler.UNDERSCORE || ch == PathWildcardCompiler.DASH) {
                            ...
                            throw new Error({
                                ...
                                filename: path,
                                number: i,
                                message: 'Path contains non-standard characters.'
                            });
                        }
...
], function (Version, History, $, _, Event, Error, Widget, Layout, View, Template) {
...
], function (Version, $, _, DefHelpers, Event, Error, Ajax) {
...
define('yfjs/spa/util/widget', [
    ...
    '../ui/loading'
], function (Version, $, _, Event, Error, Remote,
